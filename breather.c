...
int main() {
	...
	alphaby4 = beta / 4.0;
	fp = fopen("original/toten.dat","w");
	fp1 = fopen("original/strsh.dat","w");
	fp3 = fopen("original/velsh.dat","w");
	fp5 = fopen("original/cmass.dat","w");
	fp2 = fopen("original/restart.dat","w");
	fp6 = fopen("original/ke.dat","w");
	fp7 = fopen("original/acce.dat","w");
	fp8 = fopen("original/pe.dat","w");
